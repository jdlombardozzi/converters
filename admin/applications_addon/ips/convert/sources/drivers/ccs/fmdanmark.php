<?php
$info = array( 'key'   => 'fmdanmark',
			   'name'  => 'FMDanmark',
			   'login' => false );

$parent = array( 'required' => true, 'choices' => array( array('app' => 'board', 'key' => 'phpbb', 'newdb' => false) ) );

class admin_convert_fmdanmark extends ipsCommand
{
	...
	*/
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		$this->lib->sendHeader( 'FMDanmark CMS &rarr; IP.Content Converter' );
	...
	public function countRows($action)
	{
		switch ($action)
		{
			case 'ccs_database_categories':
                return $this->lib->countRows('multi_news_cat');
				break;

			case 'ccs_articles':
				return $this->lib->countRows('multi_news');
				break;

            case 'ccs_database_comments':
                return $this->lib->countRows('multi_news_com');
            	break;

			case 'attachments':
				return $this->lib->countRows('multi_news', "picture != ''");
				break;
